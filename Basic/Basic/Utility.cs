...
namespace Basic.Utility
{
	public class Utility
	{
		...
		{
			Assembly resoucesAssembly = Assembly.GetExecutingAssembly();
			if(resoucesAssembly.GetManifestResourceInfo(embeddedFileName) == null )
			{
				throw new FileNotFoundException("File not found.", embeddedFileName);
			}
			
			Stream fileStream = resoucesAssembly.GetManifestResourceStream(embeddedFileName);
